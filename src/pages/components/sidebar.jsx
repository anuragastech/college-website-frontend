import { Home, Users, BookOpen, Calendar, GraduationCap, LayoutDashboard, CheckSquare,  } from 'lucide-react';
// FileText,
// ClipboardList, 
// Trophy
const menuItems = [
  { id: 'home', label: 'Home', icon: <Home size={24} /> },
  { id: 'teachers', label: 'Teachers', icon: <Users size={24} /> },
  ...
  { id: 'classes', label: 'Classes', icon: <LayoutDashboard size={24} /> },
